...
# Section Day/Time: Thursday 8:30-9:30
...
class CardTests(unittest.TestCase):
	...
	def test_club_suit(self):
		club_card = Card(1, 9)
		self.assertEqual(club_card.suit, "Clubs")

	def test_heart_suit(self):
		heart_card = Card(2, 8)
		self.assertEqual(heart_card.suit, "Hearts")
	...
	def test_play_war_game(self):
		test_tuple = ("This is a string", 0, 0)
		result = play_war_game(True)
		self.assertEqual(type(result), type(test_tuple))
		self.assertEqual(len(result), 3)
		self.assertEqual(type(result[0]), type(test_tuple[0]))

	def test_deck_to_string(self):
		#tests the __str__ method of the Deck class 
		d = Deck()
		result_list = []
		for c in d.cards:
	...
	def test_war_game_results(self):
		#tests whether the correct player is deemed the winner depending on the scores of the game
		result = play_war_game(True)
